var ejercicios3 = /** @class */ (function () {
    ...
    ejercicios3.prototype.ejercicio1 = function () {
        ...
        var precioFinal = 0;
        var precioUva = Number(prompt("Introduce el precio de la uva"));
        ...
        window.alert("El tipo es: ".concat(tipoUva.toUpperCase(), "\nEl tama\u00F1o: ").concat(tamanioUva, "\nLa ganacia son: ").concat(precioDD));
    };
    ejercicios3.prototype.ejercicio2 = function () {
        ...
        if (costoAlumnos == 0) {
            window.alert("El numero de alumnos es: ".concat(alumnos, "\nEl pago a la compa\u00F1ia es de: ").concat(pagoCompany));
        }
        else {
    ...
    ejercicios3.prototype.ejercicio3 = function () {
        ...
        var dia = prompt("Introduce el dia ej: lunes" !== null && "Introduce el dia ej: lunes" !== void 0 ? "Introduce el dia ej: lunes" : "");
        var turno;
        var costo;
        var impuesto;
        if (duracion <= 5) {
        ...
        if (dia != "domingo") {
            turno = prompt("Introduce el turno ej: mañana" !== null && "Introduce el turno ej: mañana" !== void 0 ? "Introduce el turno ej: mañana" : "");
            impuesto = costo * 0.01;
        }
        else {
            impuesto = costo * 0.03;
